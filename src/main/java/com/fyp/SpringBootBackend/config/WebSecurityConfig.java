...
import com.fyp.SpringBootBackend.jwt.JwtAuthorizationFilter;
...
//
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/", "/hello", "/v2/api-docs", "/swagger-resources/configuration/ui",
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and()
                ...
                .antMatchers("/", "/csrf", "/v2/api-docs", "/swagger-resources/configuration/ui",
                        "/configuration/ui", "/swagger-resources", "/swagger-resources/configuration/security",
                        "/configuration/security", "/swagger-ui.html", "/webjars/**", "/resources/**", "/error", "/api/user/**").permitAll()
